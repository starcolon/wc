    ...
    return F.loadTournament(year)
      .do((tours) => {
        ...
        if (round == 32){
          ...
          }).sort((a,b) => a.pt < b.pt || (a.f-a.a) < (b.f-b.a) || a.f < b.f)
        }
    ...
    return F
      ...
      .then((matches) => {
        if (matches.length == 0){
          ...
          // TAOTODO: Following doesn't work with last group, last match
          if (m0.group <= lastGroup[m0.round] && m0.match < (m0.round == 32) ? 11 : 1){
            ...
            if (m0.match < finalMatch){
              ...
              if (m0.round == 32 && m0.group == 7){
                nextGroup = 0;
                nextMatch = finalMatch+1;
              }
              else {
                nextGroup = m0.group + 1;  
                nextMatch = finalMatch - 1; // TAOTODO: This proceeds well?
              }
            }
          } 
          else {
