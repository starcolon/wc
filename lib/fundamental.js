...
var F = {  
  ...
  loadRecentGames: function(minYear){
    return __dbResult.load({year: {$gte: minYear}})
  },

  loadRecentGoals: function(minYear){
    return __dbScorer.load({year: {$gte: minYear}})
  },
        ...
        if (tour.round[round] == null){
          ...
          // Round 8,4,2
            ...
            for (let g=0; g<round/2; g++) {
              ...
              console.log('REFRESHING ROUND #', round); // TAODEBUG:
  ...
  viewYearSummary : function(year){
    ...
    return F
      ...
      .then((nn) => {
        ...
        let ROUND_FILTERS = {OVERALL: _, GROUP_STAGE: onlyGroup, KNOCKOUTS: onlyKO};
        ...
        // TAOTODO: Also separate home and away performances
        ...
        let groupByPlayers = function(ns){
          // TAOTODO:
          // with hattricks
        }
